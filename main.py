...
def special(char_name: str, char_class: str) -> str:
    """Characteristics are important for fun."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """It's time to your talant check."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """.
    На сайте использовал перенос строк
    через запятую, а не через плюс,
    ибо не пропускает тренажер,
    а здесь ломается инпут.
    """
    approve_choice: str = ''
    char_class: str = ''
